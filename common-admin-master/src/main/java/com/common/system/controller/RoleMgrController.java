...
public class RoleMgrController extends BaseController{
    ...
    public PageBean<RcRole> queryForPage(@RequestParam(value = "start", defaultValue = "1") int start,
    		@RequestParam(value = "length", defaultValue = "10") int pageSize, 
    		@RequestParam(value = "date", required = false) String date, 
    		@RequestParam(value = "search", required = false) String search) {
        PageInfo<RcRole> pageInfo = roleService.listForPage((start / pageSize) + 1, pageSize);
